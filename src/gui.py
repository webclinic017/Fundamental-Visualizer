...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.btn1 = Button(text="Update", command=self.update, height=2, width=10, relief=GROOVE,background='black',foreground='white',activebackground='green',activeforeground='white') #TODO: mouseover
        ...
        self.canvas1.create_window(750, 29, window=self.btn1)
